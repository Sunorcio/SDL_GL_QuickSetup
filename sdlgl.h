...
// initialises SDL window and GL context based on above defines, use instead of SDL_Init
...
extern unsigned char sdlglShaderSourceCompare(char** src,const char* srcfilepath);
// If sourcefile differs from loaded source update src and return !0

typedef SDLGLprogram SDLGLprogram;
// contains program id and their attached shader sourcefiles
